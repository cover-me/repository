...
A package for general 1d and 2d scans using qcodes. Generate a measurment log (DOCX file) and DAT data aside to qcodes db data, making the data and log available to more researchers. 
